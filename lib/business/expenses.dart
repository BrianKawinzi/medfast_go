...
class Expenses extends StatelessWidget {
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
                ...
                child: const Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        'Today',
                        style: TextStyle(fontSize: 18, color: Colors.black, fontWeight: FontWeight.normal, decoration: TextDecoration.none),
                      ),
                    ),
              ...
              const SizedBox(height: 18.0), // Space between "End Date" and the search button
                SizedBox(
                  width: double.infinity,
                  height: 60,
                  child: ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor: const Color.fromRGBO(58, 205, 50, 1), // Same color as AppBar
                    ),
  ...
  Widget build(BuildContext context) => Scaffold(
        appBar: AppBar(
          ...
          actions: [
            IconButton(
              icon: const Icon(Icons.calendar_view_month_sharp),  // This is the burger menu icon
              onPressed: () {
