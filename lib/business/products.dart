...
class Products extends StatelessWidget {
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  _customInputField(nameController, 'Product Name', 'Enter Product Name'),
                  const SizedBox(height: 16.0),
                  _customInputField(quantityController, 'Quantity in Stock', 'Enter Quantity', TextInputType.number),
                  const SizedBox(height: 16.0),
                  _customInputField(skuController, 'SKU', 'Enter SKU'),
                  const SizedBox(height: 16.0),
                  _customInputField(barcodeController, 'Barcode', 'Enter Barcode', TextInputType.number),
                  const SizedBox(height: 16.0),
                  _customInputField(sellingPriceController, 'Selling Price', 'Enter Selling Price', const TextInputType.numberWithOptions(decimal: true)),
  ...
  return Container(
    ...
    child: const Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: <Widget>[
        Text('Hey!', style: TextStyle(fontSize: 24.0, fontWeight: FontWeight.bold)),
        SizedBox(height: 10.0),
        Text("You don't have any products to sell yet.", style: TextStyle(fontSize: 20.0)),
        SizedBox(height: 10.0),
        Text("Let's add some products, it's easy to add, start tracking which products sold most or getting out of stock.", style: TextStyle(fontSize: 20.0)),
        SizedBox(height: 10.0),
        Text('Click below + Icon to add your first product.', style: TextStyle(fontSize: 20.0)),
      ],
    ),
  );
}
